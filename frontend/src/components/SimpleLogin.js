      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          ...
          <div className="space-y-2">
            <button
              onClick={() => quickLogin('raj@example.com', 'password123')}
            ...
            >
              ...
              <div className="text-gray-500">Click to login as user</div>
            </button>
            <button
              onClick={() => quickLogin('admin@guardianbyte.com', 'admin123')}
              className="w-full text-left px-3 py-2 bg-white rounded-md text-sm hover:bg-blue-100 transition-colors border border-blue-300"
            >
              <div className="font-medium">Admin Demo</div>
              <div className="text-gray-500">Click to login as admin</div>
            </button>
          </div>
        </div>
